...
static const OSSL_ALGORITHM p11prov_decoders[] = {
    { "DER", "provider=pkcs11,input=pem", p11prov_pem_decoder_p11_der_functions },
	{ "RSA:rsaEncryption", "provider=pkcs11,input=der,structure=P11", p11prov_der_decoder_p11_rsa_functions },
    { NULL, NULL, NULL }
};
